...
import 'package:flutter_modular_introduction_app/app/features/first_second_screen/first_second_screen.dart';
...
class FirstPageModule extends Module{
  ...
  List<ModularRoute> get routes => [
        ChildRoute(FirstPagePath.main, child: (context, args) => const FirstPage()),
        ChildRoute(
          FirstPagePath.firstScreenPath,
...
mixin FirstPagePath {
  static String main = AppModulesPath.firstPageModulesPath;
  static String firstScreenPath = '/first-screen/';
  static String firstPath = '$main$firstScreenPath';
